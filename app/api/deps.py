...
from app.services.onboarding_service import OnboardingService  # <- IMPORTANTE

# --- Singletons in-memory para esta demo ---
_users = UsersRepo()
...
# Seed idempotente
seed_minimal(_users, _comms, _posts, _comments)
...
onboarding_service = OnboardingService(_users, _comms)  # <- IMPORTANTE
...
# --- Dependencias tipadas para inyección ---
...
OnboardingDep = Annotated[OnboardingService, Depends(lambda: onboarding_service)]  # <- AQUÍ
